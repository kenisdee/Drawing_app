...
class DrawingApp:
    ...
    def setup_ui(self):
        ...
        self.brush_size_var = tk.IntVar(value=self.brush_sizes[0])
        self.brush_size_menu = tk.OptionMenu(control_frame, self.brush_size_var, *self.brush_sizes, command=self.update_brush_size)
